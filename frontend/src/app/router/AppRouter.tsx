...
// eBOM Editor
import { EbomEditorPage } from "../../features/ebom";
      ...
      <Route element={<DbStatusGuard />}>
        <Route element={<RequireAuth />}>
          <Route element={<AppShell />}>
            ...
            <Route path="requests" element={<Navigate to="/requests/journal?direction=incoming&type=all" replace />} />
            ...
            <Route path="requests/incoming" element={<Navigate to="/requests/journal?direction=incoming&type=all" replace />} />
            <Route path="requests/outgoing" element={<Navigate to="/requests/journal?direction=outgoing&type=all" replace />} />
            <Route path="requests/incoming/new" element={<Navigate to="/requests/new?direction=incoming" replace />} />
            <Route path="requests/outgoing/new" element={<Navigate to="/requests/new?direction=outgoing" replace />} />
            ...
            {/* eBOM Editor Routes */}
            <Route path="mdm/items/:itemId/bom" element={<EbomEditorPage />} />
            <Route path="engineering/ebom/:bomVersionId" element={<EbomEditorPage />} />

            {/* References */}
            <Route path="references" element={<ReferencesPage />} />
            <Route path="references/requests/types" element={<RequestTypesSettingsPage />} />
            <Route path="references/requests/types/new" element={<RequestTypeCardPage />} />
            <Route path="references/requests/types/:id" element={<RequestTypeCardPage />} />
            <Route path="references/requests/statuses" element={<Navigate to="/references/mdm/statuses?group=Requests" replace />} />
            <Route path="references/requests/statuses/new" element={<Navigate to="/references/mdm/statuses?group=Requests" replace />} />
            <Route path="references/requests/statuses/:id" element={<Navigate to="/references/mdm/statuses?group=Requests" replace />} />
            ...
            <Route path="administration/security/employees" element={<EmployeesSettingsPage />} />
            <Route path="administration/security/employees/new" element={<EmployeeCardPage />} />
            <Route path="administration/security/employees/:id" element={<EmployeeCardPage />} />

            <Route path="administration/security/users" element={<UsersSettingsPage />} />
            <Route path="administration/security/users/new" element={<UserCardPage />} />
            <Route path="administration/security/users/:id" element={<UserCardPage />} />
            <Route path="administration/security/users/:id/roles" element={<UserRolesCardPage />} />
            <Route path="administration/security/users/:id/reset-password" element={<UserResetPasswordCardPage />} />

            <Route path="administration/security/roles" element={<RolesSettingsPage />} />
            <Route path="administration/security/roles/new" element={<RoleCardPage />} />
            <Route path="administration/security/roles/:id" element={<RoleCardPage />} />

            <Route path="administration/requests/workflow" element={<RequestWorkflowSettingsPage />} />
            <Route path="administration/requests/workflow/:typeId/new" element={<RequestWorkflowTransitionCardPage />} />
            <Route path="administration/requests/workflow/:typeId/:id" element={<RequestWorkflowTransitionCardPage />} />

            <Route path="administration/integrations/component2020" element={<Component2020SettingsPage />} />
            <Route path="administration/integrations/component2020/runs/:runId" element={<Component2020RunCardPage />} />

            <Route path="administration/system/paths" element={<GlobalPathsSettingsPage />} />

            {/* Backward-compatible Settings routes */}
            <Route path="settings" element={<Navigate to="/administration" replace />} />
            <Route path="settings/requests/types" element={<Navigate to="/references/requests/types" replace />} />
            <Route path="settings/requests/statuses" element={<Navigate to="/references/requests/statuses" replace />} />
            <Route path="settings/requests/workflow" element={<Navigate to="/administration/requests/workflow" replace />} />
            <Route path="settings/security/employees" element={<Navigate to="/administration/security/employees" replace />} />
            <Route path="settings/security/users" element={<Navigate to="/administration/security/users" replace />} />
            <Route path="settings/security/roles" element={<Navigate to="/administration/security/roles" replace />} />
            <Route path="settings/integrations/component2020" element={<Navigate to="/administration/integrations/component2020" replace />} />
            <Route path="settings/system/paths" element={<Navigate to="/administration/system/paths" replace />} />
          </Route>
        </Route>
      </Route>
