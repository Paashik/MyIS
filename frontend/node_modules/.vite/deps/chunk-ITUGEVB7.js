...
var defaultReactRender = (node2, container) => {
  if (true) {
    const majorVersion = Number.parseInt(React33.version.split(".")[0], 10);
...
var WaveEffect = (props) => {
  ...
  const unmountRef = React35.useRef(null);
  React35.useEffect(() => {
...
var showWaveEffect = (target, info) => {
  ...
  unmountCallback = reactRender2(React35.createElement(WaveEffect, Object.assign({}, info, {
    target,
    registerUnmount
  })), holder);
};
...
var useWave = (nodeRef, className, component) => {
  ...
  const rafId = React36.useRef(null);
...
*/
//# sourceMappingURL=chunk-ITUGEVB7.js.map
