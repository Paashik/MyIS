...
- обходить модульные границы:
  ...
  - прямой доступ к Компонент‑2020 из Domain/Application. Структура доступов этой системы детализирована в [Component2020_Access_schema_mermaid.md](../Component2020_Access_schema_mermaid.md) и должна использоваться как эталон для всех интеграций;
- нарушать слои:
