...
Детализированная структура доступов Компонент‑2020, которой следует придерживаться при проектировании интеграций, описана в [Component2020_Access_schema_mermaid.md](../Component2020_Access_schema_mermaid.md).
