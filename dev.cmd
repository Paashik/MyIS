...
echo Starting backend (dotnet watch run) on http://0.0.0.0:5000 ...
start "MyIS Backend" cmd /k "cd /d d:\MyIS && dotnet watch run --project backend/src/Core.WebApi/MyIS.Core.WebApi.csproj --urls http://0.0.0.0:5000"
