...
public sealed class Component2020ManufacturersSyncHandler : IComponent2020SyncHandler
{
    ...
    private readonly ILogger<Component2020ManufacturersSyncHandler> _logger;

    public Component2020ManufacturersSyncHandler(
        ...
        ILogger<Component2020ManufacturersSyncHandler> logger)
    {
    ...
    public Component2020SyncScope Scope => Component2020SyncScope.Manufacturers;
