...
namespace MyIS.Core.Infrastructure.Migrations
{
    ...
    [Migration("20251226192456_AddStatusDictionary")]
    partial class AddStatusDictionary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyIS.Core.Domain.Customers.Entities.CustomerOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MyIS.Core.Domain.Mdm.Entities.ExternalEntityLink", b =>
                {
                    ...
                    b.HasIndex("EntityType", "ExternalSystem", "ExternalEntity", "ExternalId")
                        .IsUnique();

                    b.ToTable("external_entity_links", "integration");
                });
            ...
            modelBuilder.Entity("MyIS.Core.Domain.Statuses.Entities.Status", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("statuses", "ref");
                });

            modelBuilder.Entity("MyIS.Core.Domain.Statuses.Entities.StatusGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyIS.Core.Domain.Customers.Entities.CustomerOrder", b =>
                {
                    b.HasOne("MyIS.Core.Domain.Mdm.Entities.Counterparty", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyIS.Core.Domain.Statuses.Entities.Status", b =>
                {
                    b.HasOne("MyIS.Core.Domain.Statuses.Entities.StatusGroup", "Group")
                        .WithMany()
