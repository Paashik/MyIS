...
public sealed class ActivateAdminUserHandler
{
    private readonly IUserRepository _userRepository;

    public ActivateAdminUserHandler(IUserRepository userRepository)
    {
        _userRepository = userRepository ?? throw new ArgumentNullException(nameof(userRepository));
    }

    public async Task Handle(ActivateAdminUserCommand command, CancellationToken cancellationToken)
    {
