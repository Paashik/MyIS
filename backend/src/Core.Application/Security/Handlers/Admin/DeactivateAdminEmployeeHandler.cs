...
public sealed class DeactivateAdminEmployeeHandler
{
    private readonly IEmployeeRepository _employeeRepository;

    public DeactivateAdminEmployeeHandler(IEmployeeRepository employeeRepository)
    {
        _employeeRepository = employeeRepository ?? throw new ArgumentNullException(nameof(employeeRepository));
    }

    public async Task Handle(DeactivateAdminEmployeeCommand command, CancellationToken cancellationToken)
    {
