...
start "MyIS Backend" cmd /k "cd /d e:\MyIS && dotnet watch run --project backend/src/Core.WebApi/MyIS.Core.WebApi.csproj --urls http://localhost:5000"

echo Starting frontend (Vite dev server) on http://0.0.0.0:5173 ...
start "MyIS Frontend" cmd /k "cd /d e:\MyIS\frontend && npm run dev -- --host 0.0.0.0 --port 5173"
